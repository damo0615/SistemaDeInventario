<nav class="bg-white dark:bg-gray-800 shadow-md fixed w-full z-10">
            ...
            <div class="flex justify-between h-16">
                <div class="flex items-center">
                    ...
                    <div class="hidden md:ml-6 md:flex md:space-x-8">
                        ...
                        <a href="/proyecto/hello/vistas/caja.php" class="border-primary-500 text-gray-900 dark:text-white inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium">
                            Caja
                        </a>
        ...
        <div class="md:hidden hidden" id="mobile-menu">
            <div class="pt-2 pb-3 space-y-1">
                ...
                <a href="/proyecto/hello/vistas/caja.php" class="bg-primary-50 border-primary-500 text-primary-700 block pl-3 pr-4 py-2 border-l-4 text-base font-medium dark:bg-gray-700 dark:text-primary-400">
                    Caja
                </a>
