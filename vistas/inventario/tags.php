                ...
                <div class="md:flex md:items-center md:justify-between mb-6">
                    <div class="flex-1 min-w-0">
                        <?php
                            ...
                            <input type="text" maxlength="25" name="name" class="border border-transparent rounded-md shadow-sm text-sm font-medium text-black bg-white-500 hover:bg-white-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-white-500" required data-validate="no-especiales">
