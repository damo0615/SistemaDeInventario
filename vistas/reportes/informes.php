<?php
    ...
    include '../../db/db.php';
    $query = mysqli_query($conn, "SELECT * FROM compra INNER JOIN usuario ON compra.id_user = usuario.id ");
?>
<!DOCTYPE html>
<html lang="es">
<head>
                                    ...
                                    while($prod = $query->fetch_assoc()){
                                        ...
                                        ?>  
                                                <td class="px-6 py-4 whitespace-nowrap">
                                                    <div class="text-sm text-gray-900 dark:text-white">Pedro Perez</div>
                                                </td>
                                                <td class="px-6 py-4 whitespace-nowrap">
