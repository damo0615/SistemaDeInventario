<?php
    ...
    $query2 = mysqli_query($conn, "SELECT * FROM detalles_compra INNER JOIN compra ON detalles_compra.id_compra = compra.id INNER JOIN producto ON detalles_compra.id_producto = producto.id  WHERE compra.id = '$item'");
?>
<!DOCTYPE html>
<html lang="es">
<head>
